                ...
                <Card className="overflow-hidden hover:shadow-lg hover:-translate-y-1 transition-all">
                  <CardContent className="p-6">
                    ...
                    <div className="mb-4">
                      ...
                      <p className="text-sm text-foreground/70 mb-3">{goal.unit}</p>
                    ...
                    <div className="pt-3 border-t border-foreground/10">
                      <p className="text-sm text-foreground/70">
                        <span className="font-semibold text-foreground">{Math.round(progress)}%</span> {language === 'fr' ? "de l'objectif atteint" : 'of goal reached'}
                      </p>
                    </div>
                  </CardContent>
                </Card>
