    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-indigo-50 py-12">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {/* WISDOM */}
          <div
            onClick={() => setOpenVideo("wisdom")}
            className="cursor-pointer bg-gradient-to-br from-amber-50 to-orange-50 border-2 border-amber-200 rounded-xl p-6 text-center hover:shadow-lg transition"
          >
          ...
          {/* COURAGE */}
          <div
            onClick={() => setOpenVideo("courage")}
            className="cursor-pointer bg-gradient-to-br from-rose-50 to-pink-50 border-2 border-rose-200 rounded-xl p-6 text-center hover:shadow-lg transition"
          >
          ...
          {/* PROTECTION */}
          <div
            onClick={() => setOpenVideo("protection")}
            className="cursor-pointer bg-gradient-to-br from-blue-50 to-cyan-50 border-2 border-blue-200 rounded-xl p-6 text-center hover:shadow-lg transition"
          >
